...
public class RulesPanelBryan extends JPanel
{
    JLabel rulesTitle;
    JLabel[] ruleLabels;

    public RulesPanelBryan()
    {
        ...
        ruleLabels[7] = new JLabel("./Images/SecondClickInline.png");
        ...
        ruleLabels[18] = new JLabel("./Images/BeforePushSmall.png");
        ruleLabels[19] = new JLabel("./Images/AfterPushSmall.png");
