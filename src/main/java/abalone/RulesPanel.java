...
public class RulesPanel extends JPanel
{
    ...
    public RulesPanel()
    {
		...
		ruleLabels = new JLabel[44];
		 ...
		 ruleLabels[8] = new JLabel("          ~ First, left-click the piece at the beginning of the line.");
		 ruleLabels[9] = new JLabel("               Then, right-click another piece that is adjacent to the piece you selected.");
        ...
        ruleLabels[18] = new JLabel("      ");
        ruleLabels[19] = new JLabel("      - For a broadside move, select two or three pieces in a straight, unbroken line by left-clicking.");
        ruleLabels[20] = new JLabel("      - The images below show the board before and after a broadside move.");
        ruleLabels[21] = new JLabel(selectMultiple);
        ruleLabels[22] = new JLabel(broadsideRight);
        ...
        ruleLabels[31] = new JLabel("      - The images below show the board before and after black pushes one of white's pieces off the board.");
        ruleLabels[32] = new JLabel(beforePush);
        ruleLabels[33] = new JLabel(afterPush);
        ruleLabels[34] = new JLabel("      - Black has a line of 3 pieces, which outnumbers white's line of 2 pieces. This allows black to push,");
		ruleLabels[35] = new JLabel("          which knocks one of white's pieces off the board.");
        ruleLabels[36] = new JLabel("      - NOTE: 1 single piece can't push another single piece, since 1 is not greater than 1.");
        ruleLabels[37] = new JLabel("          ~ This is why broadside moves can't push opponents.");
        ruleLabels[38] = new JLabel("   Tips");
        ruleLabels[39] = new JLabel("      - One common strategy involves having more pieces near the center of the board, then");
        ruleLabels[40] = new JLabel("          isolating a few of your opponent's pieces on the edge to push them off without resistance.");
        ruleLabels[41] = new JLabel("      ");
        ruleLabels[42] = new JLabel("   Good luck!");
        ruleLabels[43] = new JLabel("      ");
